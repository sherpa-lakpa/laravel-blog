...
<i class="fa fa-info-circle"></i>  <strong>This is notification </strong> Try out <a href="http://startbootstrap.com/template-overviews/sb-admin-2" class="alert-link">SB Admin 2</a> for new Updates!
</div>
</div>
</div>
<!-- /.row -->
